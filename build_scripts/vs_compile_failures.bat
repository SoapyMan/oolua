...
call %testPrefix%shared_return\shared_return_int shared_return_int %1 fail
call %testPrefix%shared_return\shared_return_ptr_int shared_return_ptr_int %1 fail
call %testPrefix%shared_return\shared_return_stub shared_return_stub %1 fail
call %testPrefix%shared_return\shared_return_ref_stub shared_return_ref_stub %1 fail
call %testPrefix%shared_return\shared_return_ref_const_stub shared_return_ref_const_stub %1 fail
call %testPrefix%shared_return\shared_return_ptr_shared_ptr shared_return_ptr_shared_ptr %1 fail
